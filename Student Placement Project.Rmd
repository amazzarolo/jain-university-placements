...
```{r}
lm_fit7 <- lm(salary ~. - status - sl_no - hsc_s - degree_t - ssc_b - hsc_b - etest_p - degree_p, data = trainingSet)
summary(lm_fit7)
...
```{r}
lm_fit8 <- lm(salary ~. - status - sl_no - hsc_s - degree_t - ssc_b - hsc_b - etest_p - degree_p - mba_p, data = trainingSet)
summary(lm_fit8)
...
MAKE SHINY APP FOR LM and LOGIT MODEL PREDICTIONS.
